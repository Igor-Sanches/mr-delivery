...
import app.birdsoft.meurestaurante.tools.DialogComplement;
...
public class MainDialog {
    ...
    public void generateCurrencyAmountKeyboardDialog(final Context context, Double valor) {
        ...
        ((Button) Objects.requireNonNull(dialog.findViewById(R.id.btCancel))).setOnClickListener(v -> dialog.dismiss());
