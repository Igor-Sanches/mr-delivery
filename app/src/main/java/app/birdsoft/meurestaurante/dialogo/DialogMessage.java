...
public class DialogMessage extends AlertDialog {
    ...
    private boolean isButtonPositive = false;
    private OnPossiveButtonClicked onPossiveButtonClicked;
    private String nomeButtomPositive = "Ok", titulo = null;
    ...
    public DialogMessage(@NonNull Activity context, String msg, String titulo) {
        super(context);
        this.titulo = titulo;
        this.msg=msg;
    }
